      ...
      bg-[#292a2d] text-white relative"
        >
          ...
          {messages.length === 0 ? (
            ...
            <div ref={containerRef} className="relative flex flex-col items-center justify-start w-full mt-20
            max-h-screen overflow-y-auto">
              ...
              {isLoading && (
                <div className="flex gap-4 max-w-3xl w-full py-3">
                  <Image src={assets.logo_icon} className="h-9 w-9 p-1 border border-white/15 rounded-full" alt="" />
